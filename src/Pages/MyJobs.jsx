...
const MyJobs = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    const token = localStorage.getItem("adminToken"); // Assuming you store the admin token in local storage after login
    fetch("http://localhost:3000/myJobs", {
      headers: {
  ...
  return (
    <div className="flex">
      ...
      <div className="max-w-screen-2xl container mx-auto px-4">
        <NavAdmin />
        <div className="my-jobs-container mt-10">
