...
const Banner = ({query, handleInputChange, handleSearch}) => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14 relative ">
      <h1 className="text-5xl font-bold text-primary mb-3 mt-20">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          ...
          focus-within:ring-2 focus-within:ring-indigo-600 md:w-1/2 w-full">
            <input
              type="text"
              name="title"
              id="title"
          ...
          focus-within:ring-2 focus-within:ring-indigo-600 md:w-1/3 w-full">
            <input
              type="text"
              name="title"
              id="title"
